...
document.addEventListener('DOMContentLoaded', () => {
    ...
    var pwaName = "TFMine"; //Local Storage Names for PWA
    ...
    if (!localStorage.getItem('TFMine-Highlight')) {
        localStorage.setItem(pwaName + '-Highlight', 'red')
    ...
    function init_template() {
        ...
        if (pageTitle) {
            ...
            if (greetingExist) {
                ...
                var greetingMorning = ('FinTech DataCenter');
                var greetingAfternoon = ('FinTech DataCenter');
                var greetingEvening = ('FinTech DataCenter');
        ...
        function activateMenus() {
            ...
            if (menuActive) {
                ...
                var one = document.querySelectorAll('#' + selectedMenu)[0];
                if (one) {
                    one.classList.add('nav-item-active');
        ...
        */
        ...
        if (visitDetection) {
            ...
            var d = new Date();
            var strDate = d.geUSDTllYear() + "/" + (d.getMonth() + 1) + "/" + d.getDate();
        ...
        function copyright_year() {
            ...
            if (copyrightYear) {
                var dteNow = new Date();
                const intYear = dteNow.geUSDTllYear();
        ...
        if (checkAge.length) {
            checkAge[0].addEventListener('click', function () {
                ...
                var age = 18;
                var mydate = new Date();
                mydate.seUSDTllYear(dateBirthYear, dateBirthMonth - 1, dateBirthday);

                var currdate = new Date();
                var setDate = new Date();
                setDate.seUSDTllYear(mydate.geUSDTllYear() + age, dateBirthMonth - 1, dateBirthday);
