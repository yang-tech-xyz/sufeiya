//-----------------------------------------------------------------------
// Version:        2.2.1
// Template name:  Tophis - Wallet & Banking HTML Mobile Template
// Item URL :      https://themeforest.net/item/TFMine-wallet-banking-html-mobile-template/25738217
// Author:         Bragher
...
//-----------------------------------------------------------------------
// Dark Mode
var checkDarkModeStatus = localStorage.getItem("TFMineDarkmode");
var switchDarkMode = document.querySelectorAll(".dark-mode-switch");
var pageBodyActive = pageBody.classList.contains("dark-mode");

// Check if enable as default
if (TFMine.Dark_Mode.default) {
    pageBody.classList.add("dark-mode");
}

// Local Dark Mode
if (TFMine.Dark_Mode.local_mode.enable) {
    var nightStart = TFMine.Dark_Mode.local_mode.start_time;
    var nightEnd = TFMine.Dark_Mode.local_mode.end_time;
...
if (TFMine.Dark_Mode.auto_detect.enable)
...
switchDarkMode.forEach(function (el) {
    el.addEventListener("click", function () {
        var darkmodeCheck = localStorage.getItem("TFMineDarkmode");
...
function testMode() {
    ...
    var colorSuccess = "color: #00c6ff; font-weight:bold;"

    console.clear();
    console.log("%cTFMine", "font-size: 1.3em; font-weight: bold; color: #FFF; background-color: #000e17; padding: 10px 120px; margin-bottom: 16px;")
    ...
    testModeMsg(TFMine.PWA.enable, "PWA")
    testModeMsg(TFMine.Dark_Mode.default, "Set dark mode as default theme")
    testModeMsg(TFMine.Dark_Mode.local_mode.enable, "Local dark mode (between " + TFMine.Dark_Mode.local_mode.start_time + ":00 and " + TFMine.Dark_Mode.local_mode.end_time + ":00)")
    testModeMsg(TFMine.Dark_Mode.auto_detect.enable, "Auto detect dark mode")
    testModeMsg(TFMine.RTL.enable, "RTL")
    testModeMsg(TFMine.Test.enable, "Test mode")
    testModeMsg(TFMine.Test.alert, "Test mode alert")
